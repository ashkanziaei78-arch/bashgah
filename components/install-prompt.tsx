  ...
  if (mode === "installed") {
    return (
      <div className="fc-raised flex items-center gap-4 p-6">
        ...
        <div>
          <b className="block text-md">اپ نصب است</b>
  ...
  return (
    <div className="fc-raised grid items-center gap-6 p-7 md:grid-cols-[1fr_auto]">
      <div>
        ...
        <p className="max-w-[52ch] text-sm text-fc-muted">
        ...
        {mode === "ios" && (
          <ol className="mt-5 grid list-none gap-3 p-0 text-sm text-fc-muted">
            <li className="flex items-center gap-2.5">
              <span className="fc-num grid size-6 shrink-0 place-items-center rounded-md bg-fc-cyan/12 text-xs text-fc-cyan">
                ۱
              </span>
              در Safari دکمه‌ی
